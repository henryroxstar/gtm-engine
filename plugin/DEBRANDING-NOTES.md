...
This holds the company-agnostic plugin (skills + knowledge). **Phase 0, step 1:** import the existing `gtm-engine/` plugin here (`.claude-plugin/plugin.json`, `skills/`, `knowledge/`, `PROFILE.template.md`), then de-brand it.
