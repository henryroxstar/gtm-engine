 ...
 *   {
 *     // Resolve every hex from the active profile's brand kit — never hardcode one:
 *     //   uv run python -m gtm_core.brandkit --profile <active> [--product <slug>] \
 *     //     --key palette.canvas | palette.primary | palette.accent | palette.ink
 *     "brand": { "bg":"<palette.canvas>","accent1":"<palette.primary>","accent2":"<palette.accent>",
 *                "accent3":"<palette.accent>","textOnDark":"<palette.ink>","font":"<typography.body>" },
