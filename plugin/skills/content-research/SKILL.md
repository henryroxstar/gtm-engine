...
description: >-
  Research a planned content item into verifiable facts, quotes, counterpoints, and claims to
  avoid using web and research tools. Trigger when the user says "research this item",
  "research the content", "get facts for the post", "content research", or after a content
  plan is approved.
metadata:
  version: "0.1.0"
  phase: "1"
