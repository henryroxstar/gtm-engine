...
name: video-preview
description: >-
  Generate operator-reviewable storyboard hero stills, animatics, and unified preview cards
  before video render spend. Trigger when the user says "preview video", "storyboard this
  script", "show me video frames", or as the preview stage of creator pack.
metadata:
  version: "1.0.0"
  phase: "6"
...
Its declared interface is above (`video-preview`, tier `production`).
