...
name: builder-radar
description: >-
  Scan repo git history and project design docs to surface story-worthy build milestones and
  generate dated digests and story clusters. Trigger when the user says "run builder radar",
  "run journey radar", "scan build history", "what have we shipped that is worth a story", or
  on the weekly builder cadence.
metadata:
  version: "0.3.0"
  phase: "journey-m1"
