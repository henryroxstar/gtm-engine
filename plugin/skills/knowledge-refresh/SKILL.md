...
description: >-
  Safely scan and refresh stale knowledge pack topics from web sources, staging candidate
  updates for human promotion. Trigger when the user says "refresh knowledge", "refresh the
  knowledge pack", "update stale knowledge", "what knowledge is due", or "run the knowledge
  refresh".
metadata:
  version: "0.1.0"
  phase: "3"
