...
_A draft for discussion — no changelog, no rigid roadmap, just the current cut to align on. Render the
cut as the two phase cards (V2 recessed); keep "not building" as ordinary bullets below._
