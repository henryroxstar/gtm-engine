...
description: >-
  Turn technical requirements into an executive solution overview and architecture
  specification across Markdown and HTML deliverables. Trigger when the user says "design the
  solution for [company]", "draft an architecture for [company]", "build a solution design /
  SAD for [company]", "create architecture diagrams for [company]", or "bespoke build plan for
  [company]".
metadata:
  version: "0.5.1"
  phase: "5"
