...
description: >-
  ...
  connecting optional tools (Vibe Prospecting, Firecrawl, Higgsfield) without ever storing a
  key in a file, and proves value with a real first output: extract → review → promote → first
  output.
metadata:
  version: "0.5.0"
  phase: "1"
