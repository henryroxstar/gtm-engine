...
name: learn
description: >-
  Learn from new company materials, decks, or transcripts, showing exact diffs and asking for
  approval before updating profile knowledge. Trigger when the user says "learn from my new
  material", "learn from this doc", "learn from this deck", "update knowledge from this", or
  "intake new material".
metadata:
  version: "0.1.0"
  phase: "UX"
