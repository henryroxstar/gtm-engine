...
description: >-
  Draft a customized commercial proposal, pricing model, and business terms deck for
  enterprise prospects. Trigger when the user says "draft commercial proposal for [company]",
  "create pricing proposal", "make a commercial offer", or "build proposal deck".
metadata:
  version: "0.1.0"
