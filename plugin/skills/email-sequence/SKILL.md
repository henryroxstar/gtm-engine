...
4. **`hook-matrix.md`** + **`case-studies.md`** — `profiles/<active>/knowledge/`. The persona ×
   ...
   facts: `icp-personas.md` and `product.md`.
...
2. **Write the touches.** Touch 1: subject 1–4 words / lowercase / names the signal → `Hi <first
   ...
   delivery, a new-thread re-approach) — never "just checking in".
...
file disables that check) — the linter ships with neither list baked in.
