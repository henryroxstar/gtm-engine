...
- **Two-page discipline, but never at the cost of readability** — honour the spacing scale in
  ...
  groups). If it spills to a third page, **cut content** — tighten prose, drop the lowest-leverage
  question group, or merge two groups that resolve the same decision. **Never claw space back out of
