...
description: >-
  Evaluate project technical scope, feasibility, resource requirements, and risk boundaries
  before commercial commitment. Trigger when the user says "check solution scope for
  [company]", "scope check", "evaluate project feasibility", or "review technical delivery
  risk".
metadata:
  version: "0.2.0"
  phase: "5"
