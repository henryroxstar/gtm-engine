...
name: video-router
description: >-
  Analyze concept requirements, assets, and engine availability to route video projects to the
  optimal production lane. Trigger when the user says "make a video", "create a video", "turn
  this into a short", "I want a reel", or "which video lane should I use".
metadata:
  version: "0.8.0"
  phase: "6"
...
Its declared interface is above (`video-router`, tier `core`).
