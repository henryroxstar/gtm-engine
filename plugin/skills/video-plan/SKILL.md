...
name: video-plan
description: >-
  Plan and route video concepts into approved presets, preflights, and brief.json before
  script generation. Trigger when the user says "plan a video", "make a video", "create a
  video", "video plan", "which video lane", or as the plan stage of the creator pack.
metadata:
  version: "1.0.0"
  phase: "6"
...
Its declared interface is above (`video-plan`, tier `pipeline`).
