...
name: battlecard
description: >-
  Build a competitor battlecard from the profile's competitive-positioning pack: where we win,
  where they win, and the trap questions. Trigger when the user says "battlecard for
  [competitor]", "how do we compete with [X]", or "competitive positioning against [vendor]".
metadata:
  version: "0.1.0"
  phase: "6"
