...
name: deck-research
description: >-
  Research a target account into a structured deck dossier with persona slot-fills to feed
  presentation generation. Trigger when the user says "research [company] for a deck", "build
  a deck dossier for [company]", "get me deck research on [company]", "deep research [company]
  for slides", or "prep deck research for [persona] at [company]".
metadata:
  version: "0.1.1"
  phase: "4"
