...
description: >-
  Profile an account's engineering stack and requirements to produce a discovery brief and
  decision-mapped question bank for deep-dives. Trigger when the user says "prep me for the
  technical deep-dive with [company]", "solution discovery for [company]", "what technical
  questions should I ask [company]", "profile [company]'s stack", or "surface requirements for
  [company]".
metadata:
  version: "0.1.3"
  phase: "5"
