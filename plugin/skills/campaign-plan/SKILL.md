...
description: >-
  ...
  a self-contained, theme-aware HTML exec companion. North-star metric is SQLs; every send
  stays human-gated — this skill plans, it never sends.
metadata:
  version: "0.2.0"
  phase: "4"
...
(`campaigns.html`) can find this plan and show promised-vs-actual automatically. Save
