...
name: video-footage
description: >-
  Ingest, clip, reframe, and restyle existing video footage, screen recordings, and demo
  assets. Trigger when the user says "clip my video", "repurpose this recording", "make shorts
  from this video", "restyle this footage", or as the footage stage of creator pack.
metadata:
  version: "1.0.0"
  phase: "10"
...
Its declared interface is above (`video-footage`, tier `production`).
