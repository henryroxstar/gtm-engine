...
name: events-tracker
description: >-
  Scan upcoming industry events and meetups, compute travel budgets, track conference
  pipelines, and extract attendees into prospect stores. Trigger when the user says "run my
  events scan", "track events", "what events are coming up", "update my events spreadsheet",
  "what conferences should I attend", or "pull the guest list".
metadata:
  version: "1.0.0"
  phase: "2"
