...
description: >-
  Assemble a primary-source evidence pack from git commits, diffs, and design docs for a
  builder-story moment. Trigger when the user says "gather evidence for this moment", "pull
  the commits for this story", "research this build moment", or after Gate 1 plan approval for
  a builder item.
metadata:
  version: "0.4.0"
  phase: "journey-m2"
