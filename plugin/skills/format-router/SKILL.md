...
name: format-router
description: >-
  Route approved hooks and pillars across formats and platforms based on profile mix, budgets,
  and historical hook scores. Trigger when the user says "route this hook", "which formats
  should we produce", "cross-modal plan", or during campaign planning.
metadata:
  version: "0.1.0"
  phase: "3"
