...
## 2. How to read the seven sources — customer voice vs BD focus
...
for every company using this skill. Note that the customer-voice sections (§4/App. B) are ~100% public
data; the BD-focus sections (§5/App. C) add the proprietary-external layer on top.
```
