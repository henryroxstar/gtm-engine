...
draft already exists. Resolve them up front instead. Before writing a word, settle these five and
...
5. **Facts to verify** — list any checkable public claim (a stat, a named program, "piloted at
   national scale") going into a comment under the colleague's real identity, and **verify it before
   it enters the draft**, not after it's been shown (see the self-check).
