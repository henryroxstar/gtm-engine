"""Deterministic source-coverage collection for the ``market-intelligence`` skill.

Company-agnostic building block: :mod:`gtm_core.voc.collect` enumerates the six
market-intelligence inputs for a profile, resolves the latest artifact per source,
