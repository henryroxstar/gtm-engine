...
#: for; until 2026-09-03 those rows reached no sequence at all, because every enrollment
#: path required ``send`` and had no fallback (461 of 598 pooled rows were stranded).
#: ``repair`` admits the rows being re-aimed. ``drop`` enrols nowhere.
