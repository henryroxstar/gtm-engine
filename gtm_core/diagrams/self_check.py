...
class DiagramParser(HTMLParser):
    ...
    def handle_starttag(self, tag: str, attrs: list[tuple[str, str | None]]) -> None:  # noqa: C901, PLR0912
        tag = tag.casefold()
...
def check_motion(parser: DiagramParser, source: str, errors: list[str]) -> None:  # noqa: C901, PLR0912
