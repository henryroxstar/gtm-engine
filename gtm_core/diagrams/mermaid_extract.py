...
def _parse_flowchart(diagram: Diagram, lines: list[tuple[int, str]], header_position: int) -> None:  # noqa: C901, PLR0912
    containers: list[str] = []
...
def _parse_sequence(diagram: Diagram, lines: list[tuple[int, str]], header_position: int) -> None:  # noqa: C901, PLR0912
