...
confirmed real drift: a dotted name like "Quorum.AI" was hand-slugged to ``quorum-ai`` in
one run, but this function (unchanged from the original ``prospects_import._slug``)
produces ``quorumai``. That's an accepted, documented gap for the ~800 folders that predate
