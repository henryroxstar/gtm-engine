...
SKILL = GTMSkill(
    ...
    description=(
        ...
        "the profile knowledge pack — never hardcodes any geography or company. All "
        "sources are free (web search, browser) — no metered calls, no budget impact. "
        'This skill should be used when the user says "run my market scan", "weekly '
        'market scan", "what\'s moving in the market this week", "scan for market '
        'signals", "what should I be posting about", "catch me up on agentic AI", '
        '"content ideas", or on the Monday weekly cadence.'
    ),
)
