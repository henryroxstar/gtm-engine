...
SKILL = GTMSkill(
    ...
    description=(
        ...
        "When a live customer conversation is available, runs an interview protocol first "
        "(references/interview-protocol.md) that asks for the moment they doubted themselves "
        "most rather than for 'a story' — the former yields the first wrong call and the low "
        "point, the latter a success anecdote — and classifies the draft at validation as "
        "anecdote / accomplishment / true story, refusing to ship an accomplishment under a "
        "story's title. "
