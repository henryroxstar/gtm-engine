...
SKILL = GTMSkill(
    ...
    description=(
        ...
        "head of a real person is refused in code: `gtm_core.render_engines` serves the "
        "`presenter` role from HeyGen and never from this skill's engines, `shots_lint` fails "
        "any speaking presenter shot before spend, "
