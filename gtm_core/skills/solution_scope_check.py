...
SKILL = GTMSkill(
    ...
    description=(
        ...
        "from a generic question-type bank (`references/question-types.md`). Sources every capability "
        "claim to a `file:line` in the profile's own reference layer and fits the text in markdown "
        "*before* rendering. Reads PROFILE for "
