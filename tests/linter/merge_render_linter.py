...
"Hi 🍦," or "agents at Canopy GBS | SAP Consulting | AI & Automation | move...".
...
_SIGNAL_CONTRADICTION_RE = re.compile(
    ...
    # name — one vendor's "Know Your Agent", another's "Agent Passport", a consultancy's
    # "governed control plane", a telco's agent kill-switch, a data-privacy vendor's
    # agent-policy layer, a KYB vendor's agentic identity orchestration. Pitching agent identity to the company
    ...
    *,
    ...
    for r in rows:
        ...
        for t in touches:
            ...
            # company in three routine cases: a lowercase brand (medipath, carevault),
...
RULE_CATALOGUE: dict[str, tuple[str, str]] = {
    ...
    "seat-stakes-missing": ("brand", "Problem is at mechanism altitude, not the seat's"),
    "offer-does-their-work": ("brand", "Offer points inside their system, not at market asymmetry"),
...
def _company_invisible(row: dict, body: str) -> bool:
    ...
    three routine cases: a lowercase brand (medipath, carevault), an internal
