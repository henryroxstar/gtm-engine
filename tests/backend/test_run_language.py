...
def test_create_run_threads_resolved_language(ws_env):
    ...
    from tests.backend._protocol1 import REPO
    ...
    with (
        ...
        patch.object(runs_router, "_execute_pack_run", run_pack),
    ...
    assert [c.kwargs.get("language") for c in run_pack.call_args_list] == ["de", "ja"]
