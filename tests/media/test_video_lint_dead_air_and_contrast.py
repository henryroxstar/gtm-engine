...
def test_the_finish_plan_now_carries_the_declared_mix_facts():
    ...
    assert p.audio_context == {
        ...
        # C6: where the bed opens, and — separately — how that number was arrived at. A spec
        # that declares no `music_bed` block gets 0.0 from source "none", which is honestly
        # different from a detected zero.
        "bed_start_s": 0.0,
        "bed_offset_source": "none",
    }
