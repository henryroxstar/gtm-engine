...
# Removed 2026-09-09: two tests that required the Art. 50 line to be BURNED INTO the
# title-close card — one for its clearance under a caption box, one for a minimum hold in
# seconds. Both encoded the same premise, that the card owes the disclosure a legibility
# guarantee. It does not: agent.publish.validate_disclosure discharges the duty on the post
# text and fails closed there. The premise is what produced 77px type on a 9:16 end card.
# The card no longer renders a disclosure, so there is nothing here to assert.
