...
brain can call. A sequence built through this wrapper is **inert**: it cannot send
until a human deliberately resumes it in the Saleshandy UI. Staging is safe; sending is
