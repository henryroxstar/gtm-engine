...
Exposes these tools the brain calls (staging + read ONLY):
...
delete/revoke tool. A sequence built here is inert until a human resumes it in the
Saleshandy UI. See :mod:`agent.mcp.saleshandy.server` and
