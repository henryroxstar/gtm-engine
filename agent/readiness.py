...
Freshness is deterministic-by-file-mtime for now (the PRD explicitly defers embedding/
semantic retrieval until the messy knowledge tail demands it — same spirit applies here:
a per-file structured vintage stamp, if ever added, can replace the mtime check without
