...
> `reddit-reply`, `campaign-plan`, `voice-of-customer`, `airq-scan`, `gateway-runbook` — any skill that
> makes a capability claim. Owns the SHIPPED / CONDITIONAL / ROADMAP taxonomy and the verify-before-it-ships
> rule.
