...
- **Prospects dashboard** ([`gtm_core/prospects_dashboard.py`](../gtm_core/prospects_dashboard.py))
  — a static HTML view of the consolidated prospect state (who's ready, who needs a verified
  contact), rebuilt on `consolidate()`.
