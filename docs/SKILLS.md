...
**44 skills**, generated from the manifests in `gtm_core/skills/`. This is the single source of truth for the skill inventory — other docs link here rather than restate it.
...
| [`market-harvest`](../plugin/skills/market-harvest/SKILL.md) | core | — | Pull the external market signal that the market-intelligence brief reads, across five lanes — Syften social… |
