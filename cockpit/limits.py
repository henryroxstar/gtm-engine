...
# Telegram hard caps a single message at 4096 chars. A reply longer than this is
# split across multiple messages rather than truncated — see
# cockpit.delivery._split_for_telegram.
